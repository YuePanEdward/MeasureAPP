...
public class Protractor2 extends AppCompatActivity {
    ...
    private int flag = 0;
    private float pitchstart, pitchend,showang;
    private int k = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_protractor2);
